...
return (
  <SafeAreaView style={[styles.container, {backgroundColor:theme.background}]}>
    <View  style={styles.flat}>
      ...
      ListHeaderComponent ={() => <Text style = {{fontWeight:'bold', fontSize: 23, marginBottom:2, textAlign:'center', color: 'grey', marginTop:Platform.OS === 'ios' ? 2 : 15}}>Historial Propiedad </Text>}        
      />
    </View>
